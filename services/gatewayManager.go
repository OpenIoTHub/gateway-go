...
<body>
    ...
    <div class="tip">使用<a href="https://m.malink.cn/s/RNzqia">云亿连</a>(从应用市场搜索下载或拷贝本链接在移动端打开)扫描上述二维码添加本网关，然后添加主机，主机下面添加端口就可以访问目标端口了！<a href="https://www.bilibili.com/video/BV1Tw9pYJE4B">视频教程🌐</a><a href="https://docs.iothub.cloud/typical/index.html#casaoszimaos">文档🌐</a><a href="https://github.com/OpenIoTHub/gateway-go/v1">开源地址🌐</a></div>
    <div class="tip">Use <a href="https://github.com/OpenIoTHub/OpenIoTHub">OpenIoTHub</a> to scan the following QR code and add a gateway,then add host,add host's port,finally, enjoy remote control.<a href="https://github.com/OpenIoTHub/gateway-go/v1">HomePage🌐</a></div>
</body>
</html>
`
