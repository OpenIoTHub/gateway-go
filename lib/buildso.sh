...
go build -tags android -ldflags=-w -trimpath -o build/android/gateway_arm.so -buildmode c-shared main.go
...
go build -tags android -ldflags=-w -trimpath -o build/android/gateway_arm64.so -buildmode c-shared main.go
...
go build -tags android -ldflags=-w -trimpath -o build/android/gateway_i386.so -buildmode c-shared main.go
...
go build -tags android -ldflags=-w -trimpath -o build/android/gateway_amd64.so -buildmode c-shared main.go